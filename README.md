...
- In `C:\Users\REGISTRATION\Documents\WindowsPowerShell\` create the following file `Microsoft.PowerShell_profile.ps1`
3. Within the profile file, assign an alias to the script as follows:

```powershell
Set-Alias snvm "C:\Users\MATRICULA\snvm.ps1"
```
